...
class AdminFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Admin Dashboard", font=("Arial", 20, "bold")).pack(pady=15)
    ...
    def open_create_user_popup(self):
        ...
        if not branches:
            messagebox.showerror("Error", "Could not load branches.")
            return
            ...
            def save():
                ...
                if apt["status"] == "OCCUPIED" and new_status != "OCCUPIED":
                    if not messagebox.askyesno("Warning",
                        ...
                        f"Changing status to '{new_status}' will not remove the active lease.\n\n"
